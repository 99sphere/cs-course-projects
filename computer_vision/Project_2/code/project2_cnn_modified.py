...
train_data_set = CustomImageDataset(data_set_path="./data/MNIST_gray_total/train", transforms=transforms_train)
train_loader = DataLoader(train_data_set, batch_size=hyper_param_batch, shuffle=True)
nmtrainfile=train_data_set.length
trainlabels=train_data_set.labels

test_data_set = CustomImageDataset(data_set_path='./data/MNIST_gray_total/test', transforms=transforms_test)
